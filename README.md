...
| `DISCORD_ALERT_WEBHOOK` | No | - | Discord webhook URL for operator alerts on auth failure / disconnect. Leave blank to log only. See [docs/reliability/](docs/reliability/howto-operate-bot-connection.md). |
...
# Operator alerts (optional): Discord webhook for auth-failure/disconnect notices
